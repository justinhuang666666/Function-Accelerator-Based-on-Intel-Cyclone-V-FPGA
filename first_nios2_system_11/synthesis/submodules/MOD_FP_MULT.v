...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
...
module  MOD_FP_MULT_altfp_mult_umo
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //MOD_FP_MULT_altfp_mult_umo
//VALID FILE
...
module MOD_FP_MULT (
	...
	MOD_FP_MULT_altfp_mult_umo	MOD_FP_MULT_altfp_mult_umo_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL MOD_FP_MULT.cmp TRUE TRUE
